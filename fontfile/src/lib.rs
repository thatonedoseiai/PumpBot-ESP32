...
pub struct PbFont {
    ...
    fs: &'static Filesystem<'static, PbFlashStorage<'static>>,
...
impl PbFont {
    ...
    pub fn new(fs: &'static Filesystem<'static, PbFlashStorage>) -> Self {
        PbFont {
            // font_file: None,
            fs: fs,
            font_size: None,
...
impl PbBg {
    ...
    pub fn new(fs: &'static Filesystem<'static, PbFlashStorage<'static>>) -> Self {
        PbBg {
            // bg_file: None,
            fs: fs,
            bg_filename: None,
